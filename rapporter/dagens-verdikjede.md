...
Denne rapporten kartlegger dagens prosess fra forskning til formidlet kunnskap til innbyggere i den norske helsesektoren. Kartleggingen danner grunnlag for å identifisere utfordringer, flaskehalser og forbedringsmuligheter i verdikjeden.

Verdikjeden for kunnskapsforvaltning er sentral for at helsesektoren skal kunne tilby oppdaterte, evidensbaserte tjenester og helseråd. En systematisk forståelse av hvordan kunnskap beveger seg fra forskningsmiljøer til innbyggere er en forutsetning for å vurdere om dagens prosesser er tilstrekkelig effektive og treffsikre.

### 1.2 Avgrensning

Rapporten avgrenses til **primærbruk – helseråd til innbyggere**. Det vil si verdikjeden som ender med at innbyggere mottar kvalitetssikret helseinformasjon, typisk gjennom helsenorge.no eller andre offentlige kanaler. Rapporten dekker ikke sekundærbruk av helsedata, klinisk beslutningsstøtte i sanntid eller forskning som ikke ender i innbyggerrettet formidling.
...
Grunnlaget for evidensbasert helseinformasjon er enkeltpublikasjoner fra internasjonale forskningsmiljøer. Disse publiseres i vitenskapelige tidsskrifter etter fagfellevurdering, primært på engelsk. Forskningen spenner fra kliniske studier og epidemiologiske undersøkelser til grunnforskning. Norske forskningsmiljøer bidrar også, men den store mengden ny kunnskap genereres internasjonalt.
...
De fire strømmene beskrevet ovenfor utgjør den *styrte* delen av kunnskapsforsyningen til innbyggere. I praksis henter innbyggere også kunnskap fra en rekke kilder som ligger helt utenfor denne verdikjeden, og som ikke er underlagt noen form for offentlig styring eller kvalitetssikring:

- **KI-chatboter (ChatGPT, Gemini, Copilot m.fl.)**: Et økende antall innbyggere bruker generative KI-tjenester for å stille helsespørsmål. Svarene genereres uten garantert faglig grunnlag og kan inneholde feil eller utdatert informasjon, men oppleves ofte som autoritative.
- **Internasjonale nettsider (WebMD, Mayo Clinic, Wikipedia m.fl.)**: Engelskspråklige helseressurser med varierende kvalitetssikring, men som ikke er tilpasset norsk kontekst (annet legemiddelutvalg, annet helsesystem, andre behandlingsretningslinjer).
- **Familie, venner og personlig nettverk**: Erfaringsbasert og subjektiv rådgivning som kan ha stor innflytelse på helseadferd, men som ikke er kvalitetssikret.
- **Kommersielle aktører**: Helsekost, alternativ medisin, kosttilskuddprodusenter og andre kommersielle interesser som markedsfører produkter med helsepåstander. Ofte med interessekonflikt mellom salg og evidensbasert informasjon.

Disse kildene konkurrerer med den offentlige verdikjeden om innbyggernes oppmerksomhet. Innbyggeren navigerer selv mellom alle tilgjengelige kilder – både innenfor og utenfor verdikjeden – ofte uten å kunne vurdere kvaliteten eller aktualiteten til informasjonen. Dette betyr at den offentlige verdikjeden ikke opererer i et vakuum, men i et informasjonslandskap der den må konkurrere med kilder som ofte er raskere, mer tilgjengelige og bedre tilpasset innbyggerens umiddelbare behov.
...
En detaljert aktøranalyse med roller, ansvar og relasjoner for alle ~20 aktører i verdikjeden er beskrevet i **delrapport 8 (aktoeranalyse.md)**. Aktørkartet er organisert etter verdikjedens steg og strømmer slik de er definert i denne rapporten.
...
Kunnskapen gjennomgår ulike format- og språkskifter avhengig av hvilken strøm den følger:
...
Verdikjeden innebærer tre kritiske overganger, som primært gjelder den normerende strømmen (3a):

1. **Språkskifte engelsk → norsk**: Skjer primært i overgangen fra systematisk oversikt til retningslinjearbeid. Dette krever ikke bare oversettelse, men faglig tilpasning til norsk kontekst (helseorganisering, legemiddeltilgang, behandlingstilbud). I strøm 3b skjer dette skiftet delvis *ikke* – kliniske oppslagsverk brukes ofte på engelsk.

2. **Fagspråk → klarspråk**: Overgangen fra retningslinje til innbyggerinformasjon krever at komplekst medisinsk fagspråk gjøres tilgjengelig uten å miste presisjon. I strøm 3d (medier, pasientorganisasjoner) skjer denne overgangen på andre måter og med annen kvalitetssikring.

3. **Strukturert evidens → normerende anbefaling**: Overgangen fra kunnskapsoppsummering til retningslinje innebærer at vitenskapelig evidens veies mot verdier, ressursbruk og norsk kontekst. Denne overgangen er unik for den normerende strømmen – de øvrige strømmene formidler kunnskap uten formell normering.

### 5.3 Konsistens på tvers av strømmer

At fire parallelle strømmer formidler kunnskap med ulik hastighet og ulike aktører skaper utfordringer for konsistens:

- Helsepersonell kan motta ulike anbefalinger fra nasjonale retningslinjer og kliniske oppslagsverk, særlig i perioder der retningslinjene ikke er oppdatert.
- Innbyggere kan finne informasjon i medier som ennå ikke er reflektert på helsenorge.no.
- Legemiddelinformasjon fra DMP/Felleskatalogen kan avvike fra det som står i retningslinjene dersom nye sikkerhetssignaler har kommet etter retningslinjens publisering.

Det finnes i dag ingen overordnet mekanisme som sikrer konsistens mellom de fire strømmene.

### 5.4 Manglende standardisering

Dokumentasjonen indikerer at det i dag mangler gjennomgående standardiserte maskinlesbare formater for kunnskapsinnhold på tvers av strømmene. Retningslinjer publiseres i hovedsak som fritekst-dokumenter, og det er begrenset bruk av strukturerte metadata som muliggjør automatisert videreforedling og synkronisering mellom strømmene.
...
- Innbyggere henter i tillegg kunnskap fra kilder helt utenfor verdikjeden – KI-chatboter, internasjonale nettsider, venner/familie og kommersielle aktører – som den offentlige verdikjeden i praksis konkurrerer med om oppmerksomhet og tillit
